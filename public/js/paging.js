...
function  updatePagination(btnArr){
  ...
  console.log(btnArr);
  allBtn="";
  pageNumberBar = " <li class='page-item'> <a id='prevBtn' onclick='prevBtnClick()' class='page-link' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span> <span class='sr-only'>Previous</span> </a> </li>"
